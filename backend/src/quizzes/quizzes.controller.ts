...
import { ResponsesDocument } from 'src/responses/responses.schema';
...
@Post(':course_code/:quizId/:username/submit')  // Both quizId and username are part of the URL path
async submitQuiz(
  @Param('course_code') course_code: string,  // Extract quizId from params
