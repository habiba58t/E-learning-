...
@Module({
  ...
  providers: [InstructorService, StudentService,CoursesService, UsersService, ProgressService,ResponsesService, NotesService,ModulesService,QuizzesService,ContentService,QuestionsService,NotificationService ],
  controllers: [InstructorController],
  exports: [InstructorService, StudentService,CoursesService, UsersService, ProgressService,ResponsesService, NotesService,ModulesService,QuizzesService,ContentService,QuestionsService,NotificationService ],
