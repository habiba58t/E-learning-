  ...
  return (
    <>
      <motion.button
        ...
        className="fixed top-4 left-4 z-20 p-2 bg-blue-600 text-white rounded-full"
      ...
      <motion.div
        className="fixed left-0 top-0 h-screen bg-blue-600 text-white p-6 z-10"
        initial="closed"
      ...
      >
        ...
        <ul className="space-y-6">
          ...
          <li>
            <Link href="/student/studentCourses" className="block text-lg hover:bg-gray-700 py-2 px-4 rounded">
              My Courses
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/student/progress" className="block text-lg hover:bg-gray-700 py-2 px-4 rounded">
              Progress
            </Link>
          </li>
          <li>
