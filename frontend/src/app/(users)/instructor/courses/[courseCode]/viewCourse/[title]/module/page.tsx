      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <button
            ...
            className={`px-3 py-1 rounded-lg text-white ${module.isOutdated ? 'bg-red-600' : 'bg-green-600'} shadow-md hover:opacity-90`}
          >
          ...
          <button
            ...
            className="px-3 py-1 bg-yellow-600 text-white rounded-lg shadow-md hover:bg-yellow-700 transition-all"
          >
            Update Module Level
          </button>
          ...
          <button
            className="px-3 py-1 rounded-lg bg-blue-600 text-white shadow-md hover:bg-blue-700"
          ...
          <button
            className="px-3 py-1 rounded-lg bg-teal-600 text-white shadow-md hover:bg-teal-700"
            onClick={() => handleChat()}
          >
            Chat
          </button>
          ...
          {showModal && (
            <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
              <div className="bg-white rounded-lg shadow-lg p-6 w-1/3">
                <h2 className="text-lg font-bold text-gray-800 mb-4">Add Content to Module</h2>
  
                <label className="block mb-2 text-sm font-medium text-gray-800">Content Title:</label>
                <input
                  type="text"
                  value={contentTitle}
                ...
                <label className="block mb-2 text-sm font-medium text-gray-800">Select File:</label>
                <input
                  type="file"
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-white ${isUploading ? "bg-gray-400" : "bg-blue-600 hover:bg-blue-700"}`}
                    disabled={isUploading}
                  >
          ...
          {showForm && (
            <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
              <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <div className="mb-4">
                  <label htmlFor="moduleLevel" className="block text-gray-800 font-medium mb-1">
                    Select Level:
                  </label>
                  <select
                    id="moduleLevel"
            ...
            {contentList.map((content, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute right-0 bg-gradient-to-r from-teal-500 via-blue-500 to-indigo-600 text-white font-semibold py-2 px-4 rounded-full hover:opacity-90 transition-all"
                >
                  Delete
                </button>
